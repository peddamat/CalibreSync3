...
struct SearchView: View {
  ...
  let array = [
    "Peter", "Paul", "Mary", "Anna-Lena", "George", "John", "Greg", "Thomas", "Robert", "Bernie",
    "Mike", "Benno", "Hugo", "Miles", "Michael", "Mikel", "Tim", "Tom", "Lottie", "Lorrie",
    "Barbara",
  ]
  ...
  var body: some View {
    ...
    HStack {
      HStack {
        ...
        TextField(
          "Search", text: self.$store.searchString,
        ...
        Button(action: {
          ...
          Image(systemName: "xmark.circle.fill").opacity(
            self.store.searchString.isEmpty ? 0.0 : 1.0)
        }
      }
