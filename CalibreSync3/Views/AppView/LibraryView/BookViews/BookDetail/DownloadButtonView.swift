  ...
  var body: some View {
    Button(action: {
          ...
          .overlay(
            VStack {
              Rectangle()
                ...
                .frame(
                  minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: CGFloat(50 * progress)
                )
                .cornerRadius(10)
      ...
      NotificationCenter.default.addObserver(
        forName: .downloadProgressUpdate, object: nil, queue: .main
      ) { (notification) in
        //                self.progress2 = 0
...
struct DownloadButtonView_Previews: PreviewProvider {
  static var previews: some View {
    DownloadButtonView(
      bookID: 1, format: "PDF", fileLocalURL: URL(string: "/")!, fileRemoteURL: "/", isCached: true)
  }
}
